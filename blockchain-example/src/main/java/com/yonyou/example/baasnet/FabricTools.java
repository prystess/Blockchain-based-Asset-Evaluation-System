...
public class FabricTools {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FabricTools.class.getName());
     ...
     * @param keyFile
     * @param certFile
     * @return com.yonyou.example.baasnet.FabricUser
    ...
    public String query(HFClient hfClient, String channelname, String ccName, String fn, String... args) throws Exception {
        ...
        logger.info(String.format("返回结果 => %s\n", responseArray[0].getProposalResponse().getResponse().getPayload().toStringUtf8()));
